...
- [x] 2.0 Implement Filtering Logic in the API
...
- [x] 3.0 Add and Update Tests for Filtering
...
- [x] 4.0 Update Postman collection with search and filter queries and tests
