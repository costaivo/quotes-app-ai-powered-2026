  ...
  try {
    ...
    const quotes = [
      ...
      },
      {
        ...
        author: 'Thomas A. Edison',
        tags: 'persistence;failure',
        likes: 0,
      },
      {
        text: "Don't watch the clock; do what it does. Keep going.",
        author: 'Sam Levenson',
        tags: 'persistence;action',
        likes: 0,
      },
      {
      ...
      },
      {
        ...
        author: 'Franklin D. Roosevelt',
        tags: 'persistence;hope',
        likes: 0,
      },
      {
        text: 'It is never too late to be what you might have been.',
        author: 'George Eliot',
        tags: 'motivation;potential',
        likes: 0,
      },
      {
      ...
      },
      {
        ...
        tags: 'winning;persistence',
        likes: 0,
      },
      {
        text: "Don't stop when you're tired. Stop when you're done.",
        author: 'Unknown',
        tags: 'persistence;hard-work',
        likes: 0,
      },
      {
        text: "Opportunities don't happen, you create them.",
        author: 'Chris Grosser',
        tags: 'opportunity;success',
        likes: 0,
      },
      {
      ...
      {
        text: "Victory is sweetest when you've known defeat.",
        author: 'Malcolm S. Forbes',
        tags: 'winning;victory',
        likes: 0,
      },
      {
      ...
      {
        text: 'Winning takes talent, to repeat takes character.',
        author: 'John Wooden',
        tags: 'winning;character',
        likes: 0,
      },
      {
        text: 'Persistence guarantees that results are inevitable.',
        author: 'Paramahansa Yogananda',
        tags: 'persistence;results',
        likes: 0,
      },
      {
        text: 'Energy and persistence conquer all things.',
        author: 'Benjamin Franklin',
        tags: 'persistence;energy',
        likes: 0,
      },
      {
      ...
      {
        text: 'Paralyze resistance with persistence.',
        author: 'Woody Hayes',
        tags: 'persistence;resistance',
        likes: 0,
      },
      {
      ...
      {
        text: 'Life is 10 percent what you make it, and 90 percent how you take it.',
      ...
      {
        text: 'Life is better when you are laughing.',
        author: 'Unknown',
        tags: 'life;happiness',
        likes: 0,
      },
      ...
      {
        text: "Lighten up, just enjoy life, smile more, laugh more, and don't get so worked up about things.",
      ...
      {
        text: "Life is beautiful because it doesn't last.",
        author: 'Brit Marling',
        tags: 'life;impermanence',
        likes: 0,
      },
      {
        text: 'The beauty of life is, while we cannot undo what is done, we can see it, understand it, learn from it and change.',
      ...
      {
        text: 'Life is beautiful if you know where to look.',
        author: 'Unknown',
        tags: 'life;perspective',
        likes: 0,
      },
      {
        text: 'There is beauty in everything, just not everybody sees it.',
        author: 'Andy Warhol',
        tags: 'beauty;perception',
        likes: 0,
      },
      {
        text: 'Life is full of beauty. Notice it.',
        author: 'Ashley Smith',
        tags: 'life;beauty',
        likes: 0,
      },
      ...
      {
        text: 'Life is beautiful not because of the things we see or do. Life is beautiful because of the people we meet.',
        author: 'Simon Sinek',
        tags: 'life;people',
        likes: 0,
      },
      ...
      {
        text: 'Life is a one time offer, use it well.',
        author: 'Unknown',
        tags: 'life;opportunity',
        likes: 0,
      },
      {
        text: 'Simply enjoy life and the great pleasures that come with it.',
      ...
      {
        text: 'Life is a daring adventure or nothing.',
        author: 'Helen Keller',
        tags: 'life;adventure',
        likes: 0,
      },
      ...
      {
        text: 'Life is beautiful, enjoy the ride.',
        author: 'Unknown',
        tags: 'life;journey',
        likes: 0,
      },
      {
        text: 'Beautiful things happen when you distance yourself from negativity.',
        author: 'Unknown',
        tags: 'life;positivity',
        likes: 0,
      },
      {
        text: "Life is amazing. And then it's awful. And then it's amazing again.",
        author: 'L.R. Knost',
        tags: 'life;ups-downs',
        likes: 0,
      },
      {
        text: 'Live for each second without hesitation.',
        author: 'Elton John',
        tags: 'life;carpe-diem',
        likes: 0,
      },
      {
      ...
      {
        text: 'A trophy carries dust. Memories last forever.',
      ...
      {
        text: 'I always felt that my greatest asset was not my physical ability, it was my mental ability.',
        author: 'Bruce Jenner',
        tags: 'sports;mindset',
        likes: 0,
      },
      ...
      {
        text: 'One man practicing sportsmanship is far better than 50 preaching it.',
        author: 'Knute Rockne',
      ...
      {
        text: 'Procrastination is one of the most common and deadliest of diseases and its toll on success and happiness is heavy.',
        author: 'Wayne Gretzky',
        tags: 'sports;discipline',
        likes: 0,
      },
      {
        text: 'You control your own wins and losses.',
        author: 'Maria Sharapova',
        tags: 'sports;responsibility',
        likes: 0,
      },
      {
        text: 'I think that everything is possible as long as you put your mind to it and you put the work and time into it.',
        author: 'Michael Phelps',
        tags: 'sports;possibility',
        likes: 0,
      },
      {
        text: "Winning isn't getting ahead of others. It is getting ahead of yourself.",
      ...
      {
        text: "I know what I have to do, and I'm going to do whatever it takes. If I do it, I'll come out a winner, and it doesn't matter what anyone else does.",
        author: 'Florence Griffith Joyner',
        tags: 'sports;determination',
        likes: 0,
      },
      {
      ...
      {
        text: "When you've got something to prove, there's nothing greater than a challenge.",
        author: 'Terry Bradshaw',
        tags: 'sports;challenge',
        likes: 0,
      },
      {
      ...
      },
      {
        ...
        author: 'Michael Jordan',
        tags: 'sports;attitude',
        likes: 0,
      },
      {
        text: 'Every strike brings me closer to the next home run.',
        author: 'Babe Ruth',
        tags: 'sports;optimism',
        likes: 0,
      },
      {
      ...
      },
      {
        ...
        author: 'Yogi Berra',
        tags: 'sports;observation',
        likes: 0,
      },
      {
        text: 'Love is the most important thing in the world, but baseball is pretty good, too.',
        author: 'Yogi Berra',
        tags: 'sports;love',
        likes: 0,
      },
      ...
      {
        text: 'Above anything else, I hate to lose.',
        author: 'Jackie Robinson',
        tags: 'sports;winning',
        likes: 0,
      },
      {
        text: 'There are only two seasons - winter and baseball.',
        author: 'Bill Veeck',
        tags: 'sports;passion',
        likes: 0,
      },
      {
        text: 'During my 18 years I came to bat almost 10,000 times. I struck out about 1,700 times and walked maybe 1,800 times. You figure a ballplayer will average about 500 at bats a season. That means I played seven years without ever hitting the ball.',
        author: 'Mickey Mantle',
        tags: 'sports;statistics',
        likes: 0,
      },
      {
        text: "If I knew I was going to live this long, I'd have taken better care of myself.",
        author: 'Mickey Mantle',
        tags: 'sports;health',
        likes: 0,
      },
      ...
      {
        text: 'Hitting is 50% above the shoulders.',
        author: 'Ted Williams',
        tags: 'sports;mental',
        likes: 0,
      },
      {
        text: 'Man is not made for defeat.',
        author: 'Ernest Hemingway',
        tags: 'persistence;resilience',
        likes: 0,
      },
      {
        text: 'There is no way around the hard work. Embrace it.',
        author: 'Roger Federer',
        tags: 'sports;work',
        likes: 0,
      },
      {
        text: 'You have to believe in the long term plan you have but you need the short term goals to motivate and inspire you.',
        author: 'Roger Federer',
        tags: 'sports;goals',
        likes: 0,
      },
      ...
      {
        text: 'You are never really playing an opponent. You are playing yourself, your own highest standards, and when you reach your limits, that is real joy.',
        author: 'Arthur Ashe',
        tags: 'sports;standards',
        likes: 0,
      },
      {
      ...
      },
      {
        ...
        author: 'Stephen King',
        tags: 'horror;psychology',
        likes: 0,
      },
      {
        text: 'French is the language that turns dirt into romance.',
        author: 'Stephen King',
        tags: 'language;humor',
        likes: 0,
      },
      {
        text: 'Only enemies speak the truth; friends and lovers lie endlessly, caught in the web of duty.',
        author: 'Stephen King',
